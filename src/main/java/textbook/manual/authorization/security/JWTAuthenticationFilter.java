...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            textbook.manual.authorization.models.dtos.entities.User creds = new ObjectMapper()
                    .readValue(req.getInputStream(), textbook.manual.authorization.models.dtos.entities.User.class);
            textbook.manual.authorization.models.dtos.entities.User user = userService.findByLogin(creds.getLogin());
